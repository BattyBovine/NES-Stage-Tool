...
void GlobalTilesetManager::getBankSelections(int b0, int b1,
											 ...
											 int b6, int b7)
{
	this->iBankList[0] = b0; this->iBankList[1] = b1;
	this->iBankList[2] = b2; this->iBankList[3] = b3;
	this->iBankList[4] = b4; this->iBankList[5] = b5;
	this->iBankList[6] = b6; this->iBankList[7] = b7;
	this->loadCHRBank();
}
